<div>
                    ...
                    ">
                            ...
                            <div class="content-body">
                                <div class="quiz-wrapper   rounded">
                                    ...
                                    <div class="quiz quiz-content rounded d-none" quiz-index="{{ $index + 1 }}" quiz-id="{{ $question->id }}" style="" >
                                        <input value="{{ $question->id }}" class="d-none" name="question_id" />
                                        <div style="border-radius: 5px; box-shadow: 4px 4px 1rem #00000099 !important;" class="question-title bg-white p-2"  >
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-primary" wire:click="submitQuiz">Xác nhận</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    z-index: 1050; /* Đặt z-index cao hơn để nằm trên các phần tử khác */
    display: flex;
...
.modal-header {
    border-bottom: 1px solid #dee2e6; /* Đường kẻ dưới header */
}
...
.modal-footer {
    display: flex;
    justify-content: flex-end; /* Căn chỉnh các nút ở phía bên phải */
    padding: 15px; /* Khoảng cách bên trong footer */
}

.btn-primary {
    background: #ed7237; /* Màu nền cho nút xác nhận */
    border: none; /* Không có đường viền */
}

.btn-primary:hover {
    background: #d06633; /* Màu nền khi hover */
